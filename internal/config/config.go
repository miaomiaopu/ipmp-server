...
func Load() (*Config, error) {
	...
	v.BindEnv("database.postgres.host", "PG_HOST")
	v.BindEnv("database.postgres.port", "PG_PORT")
	v.BindEnv("database.postgres.user", "PG_USER")
	v.BindEnv("database.postgres.password", "PG_PASSWORD")
	v.BindEnv("database.postgres.name", "PG_NAME")
	v.BindEnv("database.postgres.sslmode", "PG_SSLMODE")
	v.BindEnv("database.mysql.host", "MYSQL_HOST")
	v.BindEnv("database.mysql.port", "MYSQL_PORT")
	v.BindEnv("database.mysql.user", "MYSQL_USER")
	v.BindEnv("database.mysql.password", "MYSQL_PASSWORD")
	v.BindEnv("database.mysql.name", "MYSQL_NAME")
	v.BindEnv("database.mysql.charset", "MYSQL_CHARSET")

	v.BindEnv("jwt.secret", "JWT_SECRET")
	v.BindEnv("jwt.refresh_secret", "JWT_REFRESH_SECRET")
	v.BindEnv("encryption.key", "IPMP_ENCRYPTION_KEY")
	v.BindEnv("cors.origins", "CORS_ORIGINS")
	v.BindEnv("ai.deepseek.api_key", "DEEPSEEK_API_KEY")
	v.BindEnv("ai.openai.api_key", "OPENAI_API_KEY")
	v.BindEnv("ai.claude.api_key", "CLAUDE_API_KEY")
